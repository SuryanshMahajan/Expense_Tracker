...
const AuthLayout = ({ children }) => {
    return <div className="flex">
        ...
        <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
            ...
            <div className="w-48 h-56 rounded-[48px] border-[20] border-fuchsia-600 absolute top-[30%] -right-10"></div>
            ...
            <img
                src="/Bar_Chart.avif"
                className="w-230 h-80 lg:w-[70%] absolute bottom-48 left-20 shadow-lg shadow-blue-400/15"
            />
        </div>
    </div>;
};
